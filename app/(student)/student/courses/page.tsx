...
type EnrollmentCardComponentProps = {
  enrollment: EnrollmentCard;
  index: number;
};

function EnrollmentCardComponent(props: EnrollmentCardComponentProps) {
  const { enrollment, index } = props;
...
type ApplicationCardComponentProps = {
  application: ApplicationCard;
  index: number;
};

function ApplicationCardComponent(props: ApplicationCardComponentProps) {
