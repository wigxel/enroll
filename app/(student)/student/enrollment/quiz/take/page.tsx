  ...
  if (!activeQuestions || activeQuestions.length === 0) {
    return (
      <div className="flex h-[50vh] flex-col items-center justify-center text-center px-4">
        ...
        <h2 className="text-xl font-semibold text-gray-901">
          No Quiz Available
        </h2>
      ...
      <div className="mb-8">
        ...
        <div className="h-2 w-full overflow-hidden rounded-full bg-gray-100">
          <div
            ...
            style={{
              width: `${(Object.keys(answers).length / activeQuestions.length) * 100}%`,
            }}
          />
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="ml-3 flex flex-col">
                      <span
                        className={`block text-sm font-medium ${isSelected ? "text-primary" : "text-gray-900"}`}
                      >
                        {option}
                      </span>
                    </div>
      ...
      <div className="mt-10 flex flex-col items-center justify-center border-t border-gray-200 pt-10 pb-8">
        {!allAnswered && (
          <p className="mb-4 text-sm text-amber-600 font-medium bg-amber-50 px-4 py-2 rounded-full">
            Please answer all {activeQuestions.length} questions before
            submitting.
          </p>
        )}
