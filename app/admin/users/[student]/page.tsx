...
import { ArrowLeft, Calendar, CheckCircle2, Clock, Mail, User, } from "lucide-react";
...
export default function StudentDetailsPage() {
  ...
  const enrollmentsResult = useQuery(api.enrollments.listByUserId, { userId: studentId })
